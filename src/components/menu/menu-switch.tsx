...
export const MenuSwitch: React.FC = () => { // TODO: fix issues
  ...
  return (
    ...
    <svg className="icon path w-32 h-32 fill-dark-super hover:fill-blue" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
