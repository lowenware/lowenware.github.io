    ...
    <>
      ...
      >
        <section className="sm:mb-24">
          <Slide variant="full" className="items-left" background={slide.meta.background}>
            <div className="sm:w-1/2 z-30 justify-left p-48 xl:p-144 flex flex-col items-start space-y-24">
